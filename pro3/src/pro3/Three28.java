...
public class Three28 {
	...
	public static void main(String[] args) {
		...
		if(x2+width2/2<=x1+width1/2&&x2-width2/2>=x1-width1/2&&y2+height2/2<=y1+height1/2&&y2-height2/2>=y1-height1/2) {
			...
			if((x2-width2/2>=x1-width1/2&&x2-width2/2<=x1+width1/2&&y2+height2/2<=y1+height1/2&&y2+height2/2>=y1-height1/2)||(x2+width2/2>=x1-width1/2&&x2+width2/2<=x1+width1/2&&y2+height2/2<=y1+height1/2&&y2+height2/2>=y1-height1/2)||(x2-width2/2>=x1-width1/2&&x2-width2/2<=x1+width1/2&&y2-height2/2<=y1+height1/2&&y2-height2/2>=y1-height1/2)||(x2+width2/2>=x1-width1/2&&x2+width2/2<=x1+width1/2&&y2-height2/2<=y1+height1/2&&y2-height2/2>=y1-height1/2)) {
